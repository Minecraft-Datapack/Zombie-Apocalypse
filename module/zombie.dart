...
Map Zombie = {
    ...
    "regular": {
        "command": """summon zombie ~ ~ ~ {Tags:["cst_zombie","regular"],CustomName:'{"text":"Regular Zombie"}',ArmorItems:[{},{},{},{id:"minecraft:zombie_head",Count:1b}]}"""
    },
    "shadow": {
...
class ElementalZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["elemental"]["command"]);
    }
}

class FastZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["fast"]["command"]);
    }
}

class FireZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["fire"]["command"]);
    }
}

class Nanomite extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["nanomite"]["command"]);
    }
}

class PoisonZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["poison"]["command"]);
    }
}

class RegularZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["regular"]["command"]);
    }
}
...
class Shadow extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["shadow"]["command"]);
    }
}

class SnipeZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["snipe"]["command"]);
    }
}

class SuperFastZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["superfast"]["command"]);
    }
}

class ThiccZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["thicc"]["command"]);
    }
}

class TrollZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["troll"]["command"]);
    }
}

class DoctorZombie extends Widget {
    @override
    generate(Context context) {
        return Command(Zombie["doctor"]["command"]);
    }
}

class SummonAll extends Widget {
    @override
    generate(Context context) {
        return For.of(allZombie());
    }
}

class Spawner extends Widget{
    List all_zombie = [];

    @override
    generate(Context context) {
        return For.of(allSpawner());
    }
}
